        ...
        async.series([
            ...
            function (callbackSeries) {
                ...
                async.eachSeries(sources, function (source, callbackEachSource) {
                    var wordIndex=0
                    console.log(source.name +" begining"+ lindedDataArray.length);
                        ...
                        httpProxy.get(url2, function (err, result) {
                            ...
                            if (result.results) {
                                result.results.bindings.forEach(function (item) {
                                    lindedDataArray.push({source: key, labelCTG: word, linkedId: item.id, linkedDefinition: item.definition, broader: item.broader})
            ...
            fs.writeFileSync( "D:\\NLP\\synthese\\linkedDataCTG.json" ,JSON.stringify(lindedDataArray,null,2))
